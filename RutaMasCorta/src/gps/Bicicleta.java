...
public class Bicicleta {
	...
	public static String rutaCorta(int[] camino1, int[] camino2, int[] camino3) {
		...
		sum1 = longitudTrayectoCompleto(camino1);
		sum2 = longitudTrayectoCompleto(camino2);
		sum3 = longitudTrayectoCompleto(camino3);
	...
	static int longitudTrayectoCompleto(int [] ruta) {
		int longitudTotal = 0;
		
		for (int i = 0; i < ruta.length; i++) {
			longitudTotal = longitudTotal + ruta[i];
		}
